...
export function Login() {
  ...
  // Eagerly init Firebase + subscribe to auth changes when env is set.
  useEffect(() => {
    ...
    try {
      ...
      /* keep login page interactive */
    }
  }, [firebaseReady, setUser]);

  async function handleGoogle() {
    if (!firebaseReady) {
      pushToast({
        type: 'error',
        message: t('app.firebaseNotConfigured'),
      });
      return;
    }
    try {
    ...
    <div className="login-bg min-h-screen flex items-center justify-center p-4">
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          {/* Secondary: continue without login */}
